...
import imageEid from "../pics/bday.png";
import imageEid2 from "../pics/bday (1).png";
import imageEid3 from "../pics/bday (2).png";
import imageEid4 from "../pics/bday (3).png";
    ...
    <div class="text-center flex-1">
      ...
      >
        ...
        <p class="text-sm text-secondary text-right">
          ...
          <span class="text-primary font-bold FONT-ARABIC">{name}</span>...
        </p>
